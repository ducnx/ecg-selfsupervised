...
python custom_simclr_bolts.py --batch_size 4096 --epochs 1 --lr 0.0001 --precision 16 --trafos RandomResizedCrop TimeOut --datasets /home/dxng/datasets/ECG-Zheng/zheng_fs100 --log_dir=experiment_logs/zheng
